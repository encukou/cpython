...
.. grammar-snippet:: eval
   ...
   expressions (repr): Sequence(items=[Nonterminal(value='expression'), Optional(item=OneOrMore(item=Sequence(items=[String(value="','"), Nonterminal(value='expression')]))), Optional(item=String(value="','"))])
