...
// Do not edit!
        ...
        TARGET(CALL_BOUND_METHOD_EXACT_ARGS) {
            ...
            #line 3398 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_PY_EXACT_ARGS) {
            ...
            JUMPBY(INLINE_CACHE_ENTRIES_CALL);
            DISPATCH_INLINED(new_frame);
            #line 3432 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_TYPE_1) {
            ...
            #line 3490 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3515 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3540 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3576 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3619 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_BUILTIN_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3713 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_LIST_APPEND) {
            ...
            DISPATCH();
            #line 3825 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3905 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_FUNCTION_EX) {
            ...
            #line 4022 "Python/generated_cases.c.h"
            Py_DECREF(func);
            Py_DECREF(callargs);
            Py_XDECREF(kwargs);
            ...
            #line 4030 "Python/generated_cases.c.h"
        ...
        TARGET(MAKE_FUNCTION) {
            ...
            #line 4074 "Python/generated_cases.c.h"
        ...
        TARGET(RETURN_GENERATOR) {
            ...
            goto resume_frame;
            #line 4102 "Python/generated_cases.c.h"
        }
        ...
        TARGET(FORMAT_VALUE) {
            ...
            #line 4164 "Python/generated_cases.c.h"
        ...
        TARGET(BINARY_OP) {
            ...
            #line 4204 "Python/generated_cases.c.h"
            Py_DECREF(lhs);
            Py_DECREF(rhs);
            #line 2975 "Python/bytecodes.c"
            if (res == NULL) goto pop_2_error;
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 4221 "Python/generated_cases.c.h"
