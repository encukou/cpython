...
static PyObject *
func_get_code(PyFunctionObject *op, void *Py_UNUSED(closure))
{
...
static int
func_set_code(PyFunctionObject *op, PyObject *value, void *Py_UNUSED(closure))
{
...
static PyObject *
func_get_name(PyFunctionObject *op, void *Py_UNUSED(closure))
{
    Py_INCREF(op->func_name);
    return op->func_name;
}
...
static int
func_set_name(PyFunctionObject *op, PyObject *value, void *Py_UNUSED(closure))
{
...
static PyObject *
func_get_qualname(PyFunctionObject *op, void *Py_UNUSED(closure))
{
    Py_INCREF(op->func_qualname);
...
static int
func_set_qualname(PyFunctionObject *op, PyObject *value, void *Py_UNUSED(closure))
{
...
static PyObject *
func_get_defaults(PyFunctionObject *op, void *Py_UNUSED(closure))
{
...
static int
func_set_defaults(PyFunctionObject *op, PyObject *value, void *Py_UNUSED(closure))
{
...
static PyObject *
func_get_kwdefaults(PyFunctionObject *op, void *Py_UNUSED(closure))
{
...
static int
func_set_kwdefaults(PyFunctionObject *op, PyObject *value, void *Py_UNUSED(closure))
{
    if (value == Py_None)
        value = NULL;
...
static PyObject *
func_get_annotations(PyFunctionObject *op, void *Py_UNUSED(closure))
{
...
static int
func_set_annotations(PyFunctionObject *op, PyObject *value, void *Py_UNUSED(closure))
{
    if (value == Py_None)
        value = NULL;
