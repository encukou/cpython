...
static PyObject *
descr_reduce(PyDescrObject *descr, PyObject *Py_UNUSED(args))
{
    PyObject *builtins;
    PyObject *getattr;
...
static PyObject *
mappingproxy_keys(mappingproxyobject *pp, PyObject *Py_UNUSED(args))
{
    _Py_IDENTIFIER(keys);
...
static PyObject *
mappingproxy_values(mappingproxyobject *pp, PyObject *Py_UNUSED(args))
{
...
static PyObject *
mappingproxy_items(mappingproxyobject *pp, PyObject *Py_UNUSED(args))
{
...
static PyObject *
mappingproxy_copy(mappingproxyobject *pp, PyObject *Py_UNUSED(args))
{
    _Py_IDENTIFIER(copy);
