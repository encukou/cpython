...
static inline void
_Py_SET_TYPE_impl(PyObject *ob, PyTypeObject *type)
{
    ob->ob_type = type;
}
static inline void
...
#  define Py_SET_TYPE(ob, type) _Py_SET_TYPE_impl(_PyObject_CAST(ob), type)
...
#  define Py_SET_TYPE(ob, type) _Py_SET_TYPE_impl((ob), type)
